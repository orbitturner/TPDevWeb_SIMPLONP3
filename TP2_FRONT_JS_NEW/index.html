  ...
  <div class="wrapper">
    ...
    <div class="sidebar">
      ...
      <ul>
        ...
        <li><a href="src/view/createClient.html"><i class="fas fa-user-tie"></i>Creer un Client</a></li>
        <li><a href="src/view/createAccount.html"><i class="fas fa-address-card"></i>Creer un Compte</a></li>
