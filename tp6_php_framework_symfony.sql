...
--
-- Hôte : localhost:3306
-- Généré le :  lun. 24 août 2020 à 11:58
...
--
-- Base de données :  `tp6_php_framework_symfony`
--
...
(4, 'BP-CP-20200819-4', 'SOW', 'Abdourahmane', 'sowdidi@dev.com', '199020002000', '775252525', 'Thiaroye Sur Rail', 'M', '2020-08-19', '20200819', '1|2|3|4', '0'),
(5, 'BP-CP-20200820-5', 'NIANG', 'Abdou', 'abdouniangyeumbeul@gmail.com', '1870636398650012', '775930039', 'Malika GUEDJ', 'M', '1996-01-02', '2020-08-20 12:05', '1|2|3', '0'),
(7, 'BP-CP-20200820-6', 'EDGAR', 'Emmanuel', 'emmaedgar@devSpacecom', '8956531852856', '+221785263663', 'Cite Gabon', 'M', '1999-10-13', '2020-08-20 12:47', '2|3', '0'),
(8, 'BP-CP-20200820-8', 'akhyar', 'Moussa', 'orbitturner12@gmail.com', '255', '+221 0778834589', 'Cité Keur Damel', 'M', '2020-09-05', '2020-08-20 13:11', '1|2', '0'),
(9, 'BP-CP-20200820-9', 'DIOUF', 'Yaboye', 'crazyone@gmail.com', '1990200020452', '+221785263689', 'Cite Test', 'M', '2020-08-20', '2020-08-20 13:18', '2|4', '0');
...
CREATE TABLE `compteepsx` (
  ...
  `hostAgency` int(11) DEFAULT NULL,
...
('DoctrineMigrations\\Version20200819120509', '2020-08-19 12:05:35', 11318);
...
CREATE TABLE `employee` (
  ...
  `dateNaiss` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `idUser` int(11) DEFAULT NULL,
  `agencyhost` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
ALTER TABLE `compteepsx_etats`
  ...
  ADD KEY `IDX_D4B0BB30E5930107` (`compteepsx_id`),
  ADD KEY `IDX_D4B0BB305D83CC1` (`state_id`);
...
--
ALTER TABLE `agency_state`
  ADD CONSTRAINT `FK_AD5F5DD55D83CC1` FOREIGN KEY (`state_id`) REFERENCES `state` (`id`),
  ADD CONSTRAINT `FK_AD5F5DD5CDEADB2A` FOREIGN KEY (`agency_id`) REFERENCES `agency` (`id`);
...
--
ALTER TABLE `compteepsx_etats`
  ADD CONSTRAINT `FK_D4B0BB305D83CC1` FOREIGN KEY (`state_id`) REFERENCES `state` (`id`),
  ADD CONSTRAINT `FK_D4B0BB30E5930107` FOREIGN KEY (`compteepsx_id`) REFERENCES `compteepsx` (`id`);
...
--
ALTER TABLE `profile_state`
  ADD CONSTRAINT `FK_54474D295D83CC1` FOREIGN KEY (`state_id`) REFERENCES `state` (`id`),
  ADD CONSTRAINT `FK_54474D29CCFA12B8` FOREIGN KEY (`profile_id`) REFERENCES `profile` (`id`);
...
--
ALTER TABLE `user_state`
  ADD CONSTRAINT `FK_415129A35D83CC1` FOREIGN KEY (`state_id`) REFERENCES `state` (`id`),
  ADD CONSTRAINT `FK_415129A3A76ED395` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`);
COMMIT;
